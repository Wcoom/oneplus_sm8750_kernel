...
- `CONFIG_CRYSTAL_HYBRIDSWAP_SDDC_ZMS_NATIVE`: optionally keeps validated SDDC DELTA wire objects intact in ZMS and pins their immutable resident references. It is disabled by default until device-side validation is complete; unsupported objects retain the flatten fallback.

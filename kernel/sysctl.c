...
static struct ctl_table vm_table[] = {
	...
	{
		.procname	= "zram_admission_protect_workingset",
		.data		= &sysctl_zram_admission_protect_workingset,
		.maxlen		= sizeof(int),
		.mode		= 0644,
		.proc_handler	= proc_dointvec_minmax,
		.extra1		= SYSCTL_ZERO,
	...
	{
		.procname	= "zram_admission_protect_referenced",
		.data		= &sysctl_zram_admission_protect_referenced,
		.maxlen		= sizeof(int),
		.mode		= 0644,
		.proc_handler	= proc_dointvec_minmax,
		.extra1		= SYSCTL_ZERO,
	...
	{
		.procname	= "zram_readahead_adaptive",
		.data		= &sysctl_zram_readahead_adaptive,
		.maxlen		= sizeof(int),
		.mode		= 0644,
		.proc_handler	= proc_dointvec_minmax,
		.extra1		= SYSCTL_ZERO,
	...
	{
		.procname	= "zram_readahead_max_pages",
		.data		= &sysctl_zram_readahead_max_pages,
		.maxlen		= sizeof(int),
		.mode		= 0644,
		.proc_handler	= proc_dointvec_minmax,
		.extra1		= SYSCTL_ONE,
